...
const NavBar = () => {
    ...
    return (
        ...
        <nav className='w-full flex py-6 justify-between items-center navbar '>
            ...
            <ul className='list-none sm:flex hidden justify-end items-center flex-1 margin-16'>
            ...
            <div className='sm:hidden flex flex-1 justify-end items-center'>
                ...
                my-2 min-w-[140px] rounded-xl sidebar`}>
                    <ul className='list-none flex flex-col justify-end items-center flex-1 margin-16'>
                        {navLinks.map((nav, index) => (
                            <li key={nav.id} className={`font-poppins font-normal cursor-pointer text-[16px] 
